...
API_URL = "https://0027-2401-4900-1caa-449c-7c60-e86a-8561-c4ab.ngrok-free.app:8080" 
...
def status(m):
    ...
    try:
        ...
        s.connect(('https://0027-2401-4900-1caa-449c-7c60-e86a-8561-c4ab.ngrok-free.ap', 8080))
        api_status = "Online 🟢"
        s.close()
    except:
        api_status = "Offline 🔴"
